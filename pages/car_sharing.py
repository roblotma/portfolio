...
layout = html.Div([
    ...
    html.Li("Tools: Data Wrangling, Data Exploration, ArcGIS Spatial Tools, Machine Learning"),
    ]),
    ...
    html.Img(src="assets/carsharing_data.png",style={'width': '100%'} ,className = 'center'),

    html.H3("Methodology",  className="header-text-color", style={'margin-top': '1cm'}),
    html.Img(src="assets/carsharing_methodology.png",style={'width': '100%'} ,className = 'center'),
    ...
    html.Img(id='diaporama-image', src=f'/assets/{image_data[2]["filename"]}', style={'max-width': '100%'}),
    html.P(id='diaporama-caption', children=image_data[2]["caption"], style={'text-align': 'center'}),
    html.Br(),

    html.Img(id='diaporama-image', src=f'/assets/{image_data[4]["filename"]}', style={'max-width': '100%'}),
    html.P(id='diaporama-caption', children=image_data[4]["caption"], style={'text-align': 'center'}),
    html.Br(),

    html.Img(id='diaporama-image', src=f'/assets/{image_data[5]["filename"]}', style={'max-width': '100%'}),
    html.P(id='diaporama-caption', children=image_data[5]["caption"], style={'text-align': 'center'}),
    html.Br(),
